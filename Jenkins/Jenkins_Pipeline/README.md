...
<img src="job_config.png" height=70% width=70%> </img>
...
<img src="config.png" height=70% width=70%> </img>
6. (For Delivery Pipeline) under `Components` click 'add' to add first build project 
<img src="config2.png" height=70% width=70%> </img>
4. View built Pipeline or see overview with delivery Pipeline

# Build pipeline
<img src="built.png" height=70% width=70%> </img>

# Delivery Pipeline
<img src="deliver.png" height=70% width=70%> </img>